...
@section('content')
  <div class="jumbotron jumbotron-fluid home-jumbotron" style="margin-bottom: 0; background: url({{ URL::to('/') . '/images/home_banner.jpg' }}) no-repeat center center; -webkit-background-size: cover; -moz-background-size: cover; -o-background-size: cover; background-size: cover; height: 80vh;">
    ...
    <div class="poligon-separator">
      <div class="d-flex justify-content-center flex-column align-items-center gray-bg-color" style="padding-bottom: 80px;">
      ...
      <svg viewBox="0 0 100 100" preserveAspectRatio="none">
        <polygon class="svg--sm" fill="#005aa7" points="0,0 30,100 65,21 90,100 100,75 100,100 0,100"/>
        <polygon class="svg--lg" fill="#005aa7" points="0,0 15,100 33,21 45,100 50,75 55,100 72,20 85,100 95,50 100,80 100,100 0,100" />
      </svg>
    </div>
    ...
    <div class="poligon-separator bluish-gradient">
      ...
      <svg viewBox="0 0 100 100" preserveAspectRatio="none">
        <polygon class="svg--sm" fill="#f1f1f1" points="0,0 30,100 65,21 90,100 100,75 100,100 0,100"/>
        <polygon class="svg--lg" fill="#f1f1f1" points="0,0 15,100 40,30 65,80 50,75 40,70 72,20 85,100 0,100" />
      </svg>
    </div>
