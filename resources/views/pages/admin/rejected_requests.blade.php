...
<div class="mt-5 container-fluid">
  ...
  @include('partials.admin.adoption_info_boxes', [
    ...
    'allCount' => $allCount,
    'firstBoxLink' => route('admin.adoption', ['type' => 'rejected', 'days' => 7]),
    'secondBoxLink' => route('admin.adoption', ['type' => 'rejected', 'days' => 30]),
    'thirdBoxLink' => route('admin.adoption', ['type' => 'rejected', 'days' => 365]),
  ])
