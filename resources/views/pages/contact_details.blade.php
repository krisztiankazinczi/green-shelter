...
<div class="gray-bg-color">
  <header class="poligon-separator bluish-gradient">
    ...
    <div class="mt-5 d-flex justify-content-center" style="padding-bottom: 130px;">
    ...
    <svg viewBox="0 0 100 100" preserveAspectRatio="none">
      <polygon fill="#F1F1F1" points="0,100 100,0 100,100"/>
    </svg>
  </header>
...
<div>
  ...
  <div class="container mt-4 pb-5 w-75 banner position-relative" id="contact-form-container">
